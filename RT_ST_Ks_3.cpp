...
void RT_ST_Ks_3()
{
 ...
 /*0) Declare objects and call trees */
  ...
  double n_density3, n_charged3, density_factor, Nch, Rt, St, pT_sum3, meanPtKs3, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  pttree3 ->SetBranchAddress("meanPtKs3", &meanPtKs3);
  ...
  for (int i = 0; i < entries; i++)
  {
    ...
    if (pT_lead > pT_lead_lower_cut  && pT_lead < pT_lead_upper_cut ) {   // Analyze within pT lead cut
      hprof1->Fill(St, meanPtKs3, 1);
      hprof2->Fill(Rt, meanPtKs3, 1);
