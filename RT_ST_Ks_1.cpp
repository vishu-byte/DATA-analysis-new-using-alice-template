...
void RT_ST_Ks_1() {
  ...
  double n_density1, n_charged1, density_factor, Nch, Rt, St, pT_sum1,
      meanPtKs1, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  pttree1->SetBranchAddress("meanPtKs1", &meanPtKs1);
  ...
  for (int i = 0; i < entries; i++) {
    ...
    if (pT_lead > pT_lead_lower_cut &&
      ...
      hprof1->Fill(St, meanPtKs1, 1);
      hprof2->Fill(Rt, meanPtKs1, 1);
    }
  }
  ...
  latex.DrawLatex(0.57, 0.32, "#bf{K_{S} + #bar{K_{S}}}");
