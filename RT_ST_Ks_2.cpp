...
void RT_ST_Ks_2()
{
  ...
  double n_density2, n_charged2, density_factor, Nch, Rt, St, pT_sum2, meanPtKs2, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  pttree2 ->SetBranchAddress("meanPtKs2", &meanPtKs2);
  ...
  for (int i = 0; i < entries; i++)
  {
    ...
    if (pT_lead > pT_lead_lower_cut  && pT_lead < pT_lead_upper_cut ) {   // Analyze within pT lead cut
      hprof1->Fill(St, meanPtKs2, 1);
      hprof2->Fill(Rt, meanPtKs2, 1);
 ...
 TLatex latex2;
  ...
  latex.DrawLatex(0.57,0.82,"#bf{K_{S} + #bar{K_{S}}}");
