...
void ALICEfigtemplate:: LoadLibs() {
...
void ALICEfigtemplate:: DrawLogo (Int_t logo, Double_t xmin, Double_t ymin) {
...
void ALICEfigtemplate:: myPadSetUp(TPad *currentPad, float currentLeft, float currentTop, float currentRight, float currentBottom){
...
void ALICEfigtemplate:: SetStyle(Bool_t graypalette) {
