...
void RT_ST_l_2()
{
  ...
  double n_density2, n_charged2, density_factor, Nch, Rt, St, pT_sum2, meanPtl2, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  pttree2 ->SetBranchAddress("meanPtl2", &meanPtl2);
  ...
  for (int i = 0; i < entries; i++)
  {
    ...
    if (pT_lead > pT_lead_lower_cut  && pT_lead < pT_lead_upper_cut ) {   // Analyze within pT lead cut
      hprof1->Fill(St, meanPtl2, 1);
      hprof2->Fill(Rt, meanPtl2, 1);
 ...
 TLatex latex2;
  ...
  latex.DrawLatex(0.57,0.82,"#bf{#Lambda^{0} + #bar{#Lambda^{0}}}");
