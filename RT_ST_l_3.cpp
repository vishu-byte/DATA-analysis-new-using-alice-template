...
void RT_ST_l_3()
{
  ...
  double n_density3, n_charged3, density_factor, Nch, Rt, St, pT_sum3, meanPtl3, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  pttree3 ->SetBranchAddress("meanPtl3", &meanPtl3);
  ...
  for (int i = 0; i < entries; i++)
  {
    ...
    if (pT_lead > pT_lead_lower_cut  && pT_lead < pT_lead_upper_cut ) {   // Analyze within pT lead cut
      hprof1->Fill(St, meanPtl3, 1);
      hprof2->Fill(Rt, meanPtl3, 1);
