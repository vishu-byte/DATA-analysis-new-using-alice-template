...
void RT_ST_Kpm_1() {
  ...
  double n_density1, n_charged1, density_factor, Nch, Rt, St, pT_sum1,
      meanPtkpm1, pT_lead_lower_cut, pT_lead_upper_cut;
  ...
  TProfile *hprof1 =
      new TProfile("hprof1", "ST", 100, 0, 4, 0, 5); // rope hadronization
  TProfile *hprof2 =
      new TProfile("hprof2", "RT", 100, 0, 4, 0, 5); // rope hadronization
  ...
  for (int i = 0; i < entries; i++) {
    ...
    if (pT_lead > pT_lead_lower_cut &&
      ...
      hprof1->Fill(St, meanPtkpm1, 1);
      hprof2->Fill(Rt, meanPtkpm1, 1);
    }
  }
  ...
  latex2.DrawLatex(0.57, 0.72, "#bf{Transverse Region}");
